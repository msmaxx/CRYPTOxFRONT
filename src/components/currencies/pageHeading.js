...
export default function CurrencyPageHeading({name, contract, symbol, logo, chat, twitter, website, descrption, id, upVotes, downVotes}) {
    return (
        <div>
                        ...
                        <div className="border-t border-gray-200">
                            <dl>
                                <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                    ...
                                    <dd className="mt-1 text-sm text-gray-900 font-bold sm:mt-0 sm:col-span-2"><GetPrice contractAddress={contract}/></dd>
                                </div>
                                <div className="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                    <dt className="text-sm font-medium text-gray-500">Transactions (24H)</dt>
                                    <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2"><GetTxns24h contractAddress={contract}/>
                                    </dd>
                                </div>
                                <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                    <dt className="text-sm font-medium text-gray-500">Liquidity</dt>
                                    <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2"><GetLiquidityUSD contractAddress={contract}/></dd>
                                </div>
                                {/*<div className="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
